...
ps2: nos textos abaixo eu vou manter a documentação original, que ainda faz menção ao nome antigo fo brinquedo e etc. o que importa é na hora de botar a mão na massa.


![primo play set](https://github.com/godfabber/cubetto-versao-brasileira/blob/primo/images/photo/maker-guide.jpg)
   
##1. O que é o Primo

![primo play set](https://github.com/godfabber/cubetto-versao-brasileira/blob/gh-pages/images/photo/primo.jpg)
...
![](https://github.com/godfabber/cubetto-versao-brasileira/blob/gh-pages/images/photo/logo-turtle.jpg)
